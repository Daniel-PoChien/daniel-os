...
function render(id,body){
 if(id==='luxury'){body.classList.add('luxury-body');body.innerHTML='<iframe src="luxury/?v=vesper-human-walk-2" title="Luxury building simulator" allow="fullscreen"></iframe>';}
