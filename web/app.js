...
function render(id,body){
 if(id==='luxury'){body.classList.add('luxury-body');body.innerHTML='<iframe src="luxury/?v=vesper-mobile-walk-4" title="Luxury building simulator" allow="fullscreen"></iframe>';}
