...
function openApp(id){
 ...
 const win=document.createElement('section');win.className='window';win.setAttribute('aria-label',app.name);win.setAttribute('role','region');win.tabIndex=-1;
...
setInterval(tick,1000);tick();openApp('welcome');
