...
function openApp(id){
 ...
 if(action==='close'&&!workspace.beforeClose(id))return;
...
function exportNote(){workspace.exportNote();}
...
function render(id,body){
 if(id==='luxury'){body.classList.add('luxury-body');body.innerHTML='<iframe src="luxury/?v=vesper-jump-collision-3" title="Luxury building simulator" allow="fullscreen"></iframe>';}
